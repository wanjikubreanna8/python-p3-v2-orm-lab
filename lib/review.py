...
class Review:
    ...
    def year(self, year):
        if isinstance(year, int) and year >= 2000:
            ...
            raise ValueError(
                "Year should be an integer greater than or equal to 2000."
            )
    ...
    def employee_id(self, employee_id):
        ...
        if isinstance(employee_id, int):
            ...
            if row:
                ...
                raise ValueError("employee_id must exist in the employees table")
        else:
    ...
    def save(self):
        ...
        # Should be type(self) but let's test out Review
